"""
Django settings for cookietrack project.
...
SECRET_KEY = '-fmd)+afom(^xo*7e-ty9&gof4f5&bs$n=b9(ir6k_3=!qd17q'
...
ROOT_URLCONF = 'cookietrack.urls'

WSGI_APPLICATION = 'cookietrack.wsgi.application'
